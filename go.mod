...
require (
	...
	github.com/v2fly/v2ray-core/v5 v5.19.0 // replaced
...
replace github.com/v2fly/v2ray-core/v5 => github.com/dyhkwong/v2ray-core/v5 v5.19.1-0.20240915153733-fc56b4a9f281
