...
require (
	...
	gvisor.dev/gvisor v0.0.0-20231008233240-b2504f6402e8
)

//replace github.com/v2fly/v2ray-core/v5 => ../v2ray-core

replace github.com/v2fly/v2ray-core/v5 => github.com/dyhkwong/v2ray-core/v5 v5.8.1-0.20231012151038-1337a26bc6f8
