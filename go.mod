...
require (
	...
	gvisor.dev/gvisor v0.0.0-20240129063324-55d524f60f29
)
...
replace github.com/v2fly/v2ray-core/v5 => github.com/dyhkwong/v2ray-core/v5 v5.13.1-0.20240225155651-69a1e1df1fe0
